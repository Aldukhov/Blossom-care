...
const Header: React.FC = () => {
	...
	return (
		<>
			<header
				className={classNames(styles['cs-navigation'], {
			...
			>
				<div className={classNames(styles['cs-container'])}>
					<Link
						to='/'
						className={classNames(styles['cs-logo'])}
					...
					<nav
						className={classNames(styles['cs-nav'], {
							[styles['cs-active']]: isMenuActive,
						})}
						role='navigation'
					>
						<button
							className={classNames(styles['cs-toggle'])}
							aria-label='mobile menu toggle'
							onClick={handleMenuClick}
						>
							<div className={classNames(styles['cs-box'])} aria-hidden='true'>
								<span
									className={classNames(styles['cs-line'], styles['cs-line1'])}
									aria-hidden='true'
								></span>
								<span
									className={classNames(styles['cs-line'], styles['cs-line2'])}
									aria-hidden='true'
								></span>
								<span
									className={classNames(styles['cs-line'], styles['cs-line3'])}
									aria-hidden='true'
								></span>
							</div>
						</button>
						...
						<div className={classNames(styles['cs-ul-wrapper'])}>
							<ul
								className={classNames(styles['cs-ul'], styles['cs-expanded'])}
							>
								<li className={classNames(styles['cs-li'])}>
									<Link
										to='/'
										className={classNames(styles['cs-li-link'], {
								...
								<li
									className={classNames(
										styles['cs-li'],
										styles['cs-dropdown'],
										{ [styles['cs-active']]: isToggleActive }
									)}
								...
								>
									<span
										className={classNames(styles['cs-li-link'], {
											[styles['cs-active-link']]:
												activeLink.startsWith('/services'),
										})}
									>
										Services
										<img
											className={classNames(styles['cs-drop-icon'])}
											src={down}
											alt='dropdown icon'
											width='15'
											height='15'
									...
									<ul className={classNames(styles['cs-drop-ul'])}>
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												to='/services/independent-living'
												className={classNames(
													styles['cs-li-link'],
													styles['cs-drop-link'],
													{
														[styles['cs-active-link']]:
															activeLink === '/services/independent-living',
													}
												)}
												onClick={() =>
													handleLinkClick('/services/independent-living')
												}
											>
										...
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												to='/services/community-nursing-care'
												className={classNames(
													styles['cs-li-link'],
													styles['cs-drop-link'],
													{
														[styles['cs-active-link']]:
															activeLink === '/services/community-nursing-care',
													}
												)}
												onClick={() =>
													handleLinkClick('/services/community-nursing-care')
												}
											>
										...
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												...
												onClick={() =>
													handleLinkClick('/services/community-participation')
												}
											>
										...
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												to='/services/individualised-living-options'
												className={classNames(
													styles['cs-li-link'],
													styles['cs-drop-link'],
													{
														[styles['cs-active-link']]:
															activeLink ===
															'/services/individualised-living-options',
													}
												)}
												onClick={() =>
													handleLinkClick(
										...
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												to='/services/dissability-accommodation'
												className={classNames(
													styles['cs-li-link'],
													styles['cs-drop-link'],
													{
														[styles['cs-active-link']]:
															activeLink ===
															'/services/dissability-accommodation',
													}
												)}
												onClick={() =>
													handleLinkClick('/services/dissability-accommodation')
												}
											>
										...
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												...
												className={classNames(
													...
													{
														[styles['cs-active-link']]:
															activeLink === '/services/transport',
													}
												)}
												onClick={() => handleLinkClick('/services/transport')}
											>
												Transport
											</Link>
										</li>
										<li className={classNames(styles['cs-drop-li'])}>
											<Link
												to='/services/support-coordination'
												className={classNames(
													styles['cs-li-link'],
													styles['cs-drop-link'],
													{
														[styles['cs-active-link']]:
															activeLink === '/services/support-coordination',
													}
												)}
												onClick={() =>
													handleLinkClick('/services/support-coordination')
												}
											>
					...
					<div className={classNames(styles['cs-contact-group'])}>
						<a
							...
							className={classNames(styles['cs-phone'])}
						>
							<img
								className={classNames(styles['cs-phone-icon'])}
				...
				{isDissabilityActive ? (
					<Disability isActive={isDissabilityActive} />
				) : null}
			</header>
		</>
	)
